...
uint8_t txBuf[32] = "HERE!";
uint16_t txBufLen = 32;

uint16_t lastInput;
uint16_t input;

enum RotaryState {S_IDLE, S_CW_1, S_CW_2, S_CW_3, S_CCW_1, S_CCW_2, S_CCW_3, S_UNK};
uint8_t rotary_state = S_IDLE;
uint16_t rotary_count = 0;
uint16_t rotary_tmp = 0;
