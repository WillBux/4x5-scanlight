...
__weak PWR_StatusTypeDef BSP_PWR_VBUSInit(uint32_t PortId) {
	...
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VBUSInit(PortId)) ?
			PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSDeInit(uint32_t PortId) {
	...
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VBUSDeInit(PortId)) ?
			PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSOn(uint32_t PortId) {
	...
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VBUSOn(PortId)) ?
			PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSOff(uint32_t PortId) {
	...
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VBUSOff(PortId)) ?
			PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSSetVoltage_Fixed(uint32_t PortId,
		uint32_t VbusTargetInmv, uint32_t OperatingCurrent,
		uint32_t MaxOperatingCurrent) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VBUSSetVoltage_Fixed");
	/* USER CODE BEGIN BSP_PWR_VBUSSetVoltage_Fixed */
	return ((BSP_ERROR_NONE
			== BSP_USBPD_PWR_VBUSSetVoltage_Fixed(PortId, VbusTargetInmv,
					OperatingCurrent, MaxOperatingCurrent)) ? PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSSetVoltage_Variable(uint32_t PortId,
		uint32_t VbusTargetMinInmv, uint32_t VbusTargetMaxInmv,
		uint32_t OperatingCurrent, uint32_t MaxOperatingCurrent) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VBUSSetVoltage_Variable");
	/* USER CODE BEGIN BSP_PWR_VBUSSetVoltage_Variable */
	return ((BSP_ERROR_NONE
			== BSP_USBPD_PWR_VBUSSetVoltage_Variable(PortId, VbusTargetMinInmv,
					VbusTargetMaxInmv, OperatingCurrent, MaxOperatingCurrent)) ?
			PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSSetVoltage_Battery(uint32_t PortId,
		uint32_t VbusTargetMin, uint32_t VbusTargetMax, uint32_t OperatingPower,
		uint32_t MaxOperatingPower) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VBUSSetVoltage_Battery");
	/* USER CODE BEGIN BSP_PWR_VBUSSetVoltage_Battery */
	return ((BSP_ERROR_NONE
			== BSP_USBPD_PWR_VBUSSetVoltage_Battery(PortId, VbusTargetMin,
					VbusTargetMax, OperatingPower, MaxOperatingPower)) ?
			PWR_OK : PWR_ERROR);
...
__weak PWR_StatusTypeDef BSP_PWR_VBUSSetVoltage_APDO(uint32_t PortId,
		uint32_t VbusTargetInmv, uint32_t OperatingCurrent, int32_t Delta) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VBUSSetVoltage_APDO");
	/* USER CODE BEGIN BSP_PWR_VBUSSetVoltage_APDO */
	return ((BSP_ERROR_NONE
			== BSP_USBPD_PWR_VBUSSetVoltage_APDO(PortId, VbusTargetInmv,
					OperatingCurrent, Delta)) ? PWR_OK : PWR_ERROR);
 ...
 * @retval PD controller status
 */
__weak PWR_StatusTypeDef BSP_PWR_VCONNInit(uint32_t PortId, uint32_t CCPinId) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VCONNInit");
	/* USER CODE BEGIN BSP_PWR_VCONNInit */
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VCONNInit(PortId, CCPinId)) ?
			PWR_OK : PWR_ERROR);
 ...
 * @retval PD controller status
 */
__weak PWR_StatusTypeDef BSP_PWR_VCONNDeInit(uint32_t PortId, uint32_t CCPinId) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VCONNDeInit");
	/* USER CODE BEGIN BSP_PWR_VCONNDeInit */
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VCONNDeInit(PortId, CCPinId)) ?
			PWR_OK : PWR_ERROR);
 ...
 * @retval PD controller status
 */
__weak PWR_StatusTypeDef BSP_PWR_VCONNOn(uint32_t PortId, uint32_t CCPinId) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VCONNOn");
	/* USER CODE BEGIN BSP_PWR_VCONNOn */
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VCONNOn(PortId, CCPinId)) ?
			PWR_OK : PWR_ERROR);
 ...
 * @retval PD controller status
 */
__weak PWR_StatusTypeDef BSP_PWR_VCONNOff(uint32_t PortId, uint32_t CCPinId) {
	PWR_DEBUG_TRACE(PortId, "ADVICE: Obsolete BSP_PWR_VCONNOff");
	/* USER CODE BEGIN BSP_PWR_VCONNOff */
	return ((BSP_ERROR_NONE == BSP_USBPD_PWR_VCONNOff(PortId, CCPinId)) ?
			PWR_OK : PWR_ERROR);
...
__weak void BSP_PWR_SetVBUSDisconnectionThreshold(uint32_t PortId,
	...
	(void) BSP_USBPD_PWR_SetVBUSDisconnectionThreshold(PortId,
			VoltageThreshold);
...
__weak PWR_StatusTypeDef BSP_PWR_RegisterVBUSDetectCallback(uint32_t PortId,
	...
	return ((BSP_ERROR_NONE
			== BSP_USBPD_PWR_RegisterVBUSDetectCallback(PortId,
 ...
 */
__weak uint8_t BSP_PWR_VCONNIsOn(uint32_t PortId, uint32_t CCPinId) {
 ...
 * @retval BSP status
 */
__weak int32_t BSP_USBPD_PWR_SetRole(uint32_t Instance,
 ...
 * @retval BSP status
 */
__weak int32_t BSP_USBPD_PWR_SetPowerMode(uint32_t Instance,
		USBPD_PWR_PowerModeTypeDef PwrMode) {
 ...
 * @retval BSP status
 */
__weak int32_t BSP_USBPD_PWR_GetPowerMode(uint32_t Instance,
		USBPD_PWR_PowerModeTypeDef *PwrMode) {
 ...
 * @retval BSP status
 */
__weak int32_t BSP_USBPD_PWR_VBUSGetVoltage(uint32_t Instance,
		uint32_t *pVoltage) {
	...
	if ((Instance >= USBPD_PWR_INSTANCES_NBR) || (NULL == pVoltage)) {
		...
		*pVoltage = 0;
		...
		uint32_t vadc;
		uint32_t voltage;
		value = LL_ADC_REG_ReadConversionData12(
				TCPP01_PORT0_VSENSE_ADC_INSTANCE);
		vadc = (value * VDDA_APPLI) / ADC_FULL_SCALE;
		voltage =
				vadc
						* (USBPD_PWR_VSENSE_RA + USBPD_PWR_VSENSE_RB)/ USBPD_PWR_VSENSE_RB;
		*pVoltage = voltage;
	}
	return ret;
 ...
 * @retval BSP status
 */
__weak int32_t BSP_USBPD_PWR_VBUSGetCurrent(uint32_t Instance,
		int32_t *pCurrent) {
 ...
 * @retval BSP status
 */
__weak int32_t BSP_USBPD_PWR_VCONNIsOn(uint32_t Instance, uint32_t CCPinId,
		uint8_t *pState) {
