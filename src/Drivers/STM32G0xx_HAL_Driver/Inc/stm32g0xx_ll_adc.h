...
__STATIC_INLINE void LL_ADC_SetCommonFrequencyMode(
		ADC_Common_TypeDef *ADCxy_COMMON, uint32_t CommonFrequencyMode) {
 ...
 *         @arg @ref LL_ADC_CLOCK_FREQ_MODE_LOW
 */
__STATIC_INLINE uint32_t LL_ADC_GetCommonFrequencyMode(
		const ADC_Common_TypeDef *ADCxy_COMMON) {
...
__STATIC_INLINE void LL_ADC_SetCalibrationFactor(ADC_TypeDef *ADCx,
	...
	MODIFY_REG(ADCx->CALFACT, ADC_CALFACT_CALFACT, CalibrationFactor);
}
...
__STATIC_INLINE uint32_t LL_ADC_GetLowPowerMode(const ADC_TypeDef *ADCx) {
	return (uint32_t) (READ_BIT(ADCx->CFGR1,
...
__STATIC_INLINE void LL_ADC_SetSamplingTimeCommonChannels(ADC_TypeDef *ADCx,
		uint32_t SamplingTimeY, uint32_t SamplingTime) {
 ...
 *         @arg @ref LL_ADC_SAMPLINGTIME_160CYCLES_5
 */
__STATIC_INLINE uint32_t LL_ADC_GetSamplingTimeCommonChannels(
		const ADC_TypeDef *ADCx, uint32_t SamplingTimeY) {
	return (uint32_t) ((READ_BIT(ADCx->SMPR,
			ADC_SMPR_SMP1 << (SamplingTimeY & ADC_SAMPLING_TIME_SMP_SHIFT_MASK)))
...
__STATIC_INLINE uint32_t LL_ADC_REG_GetTriggerSource(const ADC_TypeDef *ADCx) {
	__IO uint32_t trigger_source = READ_BIT(ADCx->CFGR1,
			ADC_CFGR1_EXTSEL | ADC_CFGR1_EXTEN);

	/* Value for shift of {0; 4; 8; 12} depending on value of bitfield          */
	/* corresponding to ADC_CFGR1_EXTEN {0; 1; 2; 3}.                           */
	uint32_t shift_exten = ((trigger_source & ADC_CFGR1_EXTEN)
...
__STATIC_INLINE uint32_t LL_ADC_REG_IsTriggerSourceSWStart(
	...
	return ((READ_BIT(ADCx->CFGR1, ADC_CFGR1_EXTEN)
			== (LL_ADC_REG_TRIG_SOFTWARE & ADC_CFGR1_EXTEN)) ? 1UL : 0UL);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_REG_SetSequencerConfigurable(ADC_TypeDef *ADCx,
		uint32_t Configurability) {
 ...
 *         @arg @ref LL_ADC_REG_SEQ_CONFIGURABLE
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerConfigurable(
		const ADC_TypeDef *ADCx) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_ADC_REG_SetSequencerChAdd(ADC_TypeDef *ADCx,
		uint32_t Channel) {
	/* Parameter "Channel" is used with masks because containing                */
	/* other bits reserved for other purpose.                                   */
 ...
 *             refer to function @ref LL_ADC_REG_SetSequencerConfigurable().
 */
__STATIC_INLINE uint32_t LL_ADC_REG_GetSequencerChannels(
		const ADC_TypeDef *ADCx) {
	uint32_t channels_bitfield = (uint32_t) READ_BIT(ADCx->CHSELR,
			ADC_CHSELR_CHSEL);

	return ((((channels_bitfield & ADC_CHSELR_CHSEL0)
			>> ADC_CHSELR_CHSEL0_BITOFFSET_POS) * LL_ADC_CHANNEL_0)
			| (((channels_bitfield & ADC_CHSELR_CHSEL1)
					>> ADC_CHSELR_CHSEL1_BITOFFSET_POS) * LL_ADC_CHANNEL_1)
			| (((channels_bitfield & ADC_CHSELR_CHSEL2)
					>> ADC_CHSELR_CHSEL2_BITOFFSET_POS) * LL_ADC_CHANNEL_2)
			| (((channels_bitfield & ADC_CHSELR_CHSEL3)
					>> ADC_CHSELR_CHSEL3_BITOFFSET_POS) * LL_ADC_CHANNEL_3)
			| (((channels_bitfield & ADC_CHSELR_CHSEL4)
					>> ADC_CHSELR_CHSEL4_BITOFFSET_POS) * LL_ADC_CHANNEL_4)
			| (((channels_bitfield & ADC_CHSELR_CHSEL5)
					>> ADC_CHSELR_CHSEL5_BITOFFSET_POS) * LL_ADC_CHANNEL_5)
			| (((channels_bitfield & ADC_CHSELR_CHSEL6)
					>> ADC_CHSELR_CHSEL6_BITOFFSET_POS) * LL_ADC_CHANNEL_6)
			| (((channels_bitfield & ADC_CHSELR_CHSEL7)
					>> ADC_CHSELR_CHSEL7_BITOFFSET_POS) * LL_ADC_CHANNEL_7)
			| (((channels_bitfield & ADC_CHSELR_CHSEL8)
					>> ADC_CHSELR_CHSEL8_BITOFFSET_POS) * LL_ADC_CHANNEL_8)
			| (((channels_bitfield & ADC_CHSELR_CHSEL9)
					>> ADC_CHSELR_CHSEL9_BITOFFSET_POS) * LL_ADC_CHANNEL_9)
			| (((channels_bitfield & ADC_CHSELR_CHSEL10)
					>> ADC_CHSELR_CHSEL10_BITOFFSET_POS) * LL_ADC_CHANNEL_10)
			| (((channels_bitfield & ADC_CHSELR_CHSEL11)
					>> ADC_CHSELR_CHSEL11_BITOFFSET_POS) * LL_ADC_CHANNEL_11)
			| (((channels_bitfield & ADC_CHSELR_CHSEL12)
					>> ADC_CHSELR_CHSEL12_BITOFFSET_POS) * LL_ADC_CHANNEL_12)
			| (((channels_bitfield & ADC_CHSELR_CHSEL13)
					>> ADC_CHSELR_CHSEL13_BITOFFSET_POS) * LL_ADC_CHANNEL_13)
			| (((channels_bitfield & ADC_CHSELR_CHSEL14)
					>> ADC_CHSELR_CHSEL14_BITOFFSET_POS) * LL_ADC_CHANNEL_14)
			| (((channels_bitfield & ADC_CHSELR_CHSEL15)
					>> ADC_CHSELR_CHSEL15_BITOFFSET_POS) * LL_ADC_CHANNEL_15)
			| (((channels_bitfield & ADC_CHSELR_CHSEL16)
					>> ADC_CHSELR_CHSEL16_BITOFFSET_POS) * LL_ADC_CHANNEL_16)
			| (((channels_bitfield & ADC_CHSELR_CHSEL17)
					>> ADC_CHSELR_CHSEL17_BITOFFSET_POS) * LL_ADC_CHANNEL_17)
#if defined(ADC_CCR_VBATEN)
			| (((channels_bitfield & ADC_CHSELR_CHSEL18)
					>> ADC_CHSELR_CHSEL18_BITOFFSET_POS) * LL_ADC_CHANNEL_18)
...
__STATIC_INLINE void LL_ADC_SetChannelSamplingTime(ADC_TypeDef *ADCx,
		uint32_t Channel, uint32_t SamplingTimeY) {
	/* Parameter "Channel" is used with masks because containing                */
	/* other bits reserved for other purpose.                                   */
	MODIFY_REG(ADCx->SMPR, (Channel << ADC_SMPR_SMPSEL0_BITOFFSET_POS),
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSamplingTime(const ADC_TypeDef *ADCx,
	...
	uint32_t smp_channel_posbit0 = ((smpr & ADC_SAMPLING_TIME_CH_MASK)
			>> ((((Channel & ADC_CHANNEL_ID_NUMBER_MASK)
					>> ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS)
					+ ADC_SMPR_SMPSEL0_BITOFFSET_POS) & 0x1FUL));
...
__STATIC_INLINE void LL_ADC_SetAnalogWDMonitChannels(ADC_TypeDef *ADCx,
	...
	if (AWDy == LL_ADC_AWD1) {
		...
		preg =
				__ADC_PTR_REG_OFFSET(ADCx->AWD2CR,
 ...
 *         @arg @ref LL_ADC_AWD_CHANNEL_18_REG
 */
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDMonitChannels(
		const ADC_TypeDef *ADCx, uint32_t AWDy) {
	__IO const uint32_t *preg =
			__ADC_PTR_REG_OFFSET(ADCx->CFGR1,
	...
	uint32_t analog_wd_monit_channels = (READ_BIT(*preg, AWDy) & AWDy
		...
		if (AWDy == LL_ADC_AWD1) {
			if ((analog_wd_monit_channels & ADC_CFGR1_AWD1SGL) == 0UL) {
				...
				analog_wd_monit_channels = ((analog_wd_monit_channels
						| (ADC_AWD_CR23_CHANNEL_MASK)) & (~(ADC_CFGR1_AWD1CH)));
			} else {
...
__STATIC_INLINE void LL_ADC_ConfigAnalogWDThresholds(ADC_TypeDef *ADCx,
	...
	/* containing other bits reserved for other purpose.                        */
	__IO uint32_t *preg =
			__ADC_PTR_REG_OFFSET(ADCx->AWD1TR,
					(((AWDy & ADC_AWD_TRX_REGOFFSET_MASK)) >> (ADC_AWD_TRX_REGOFFSET_BITOFFSET_POS)) + ((ADC_AWD_CR3_REGOFFSET & AWDy) >> (ADC_AWD_CRX_REGOFFSET_BITOFFSET_POS + 1UL)));
...
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDThresholds(const ADC_TypeDef *ADCx,
	...
	return (uint32_t) (READ_BIT(*preg, (AWDThresholdsHighLow | ADC_AWD1TR_LT1))
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_REG_IsStopConversionOngoing(
		const ADC_TypeDef *ADCx) {
 ...
 */
__STATIC_INLINE uint32_t LL_ADC_REG_ReadConversionData32(
		const ADC_TypeDef *ADCx) {
 ...
 * @retval Value between Min_Data=0x000 and Max_Data=0xFFF
 */
__STATIC_INLINE uint16_t LL_ADC_REG_ReadConversionData12(
		const ADC_TypeDef *ADCx) {
 ...
 */
__STATIC_INLINE uint16_t LL_ADC_REG_ReadConversionData10(
		const ADC_TypeDef *ADCx) {
...
__STATIC_INLINE uint32_t LL_ADC_IsActiveFlag_CCRDY(const ADC_TypeDef *ADCx) {
	return ((READ_BIT(ADCx->ISR, LL_ADC_FLAG_CCRDY) == (LL_ADC_FLAG_CCRDY)) ?
			1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_ADC_IsEnabledIT_CCRDY(const ADC_TypeDef *ADCx) {
	return ((READ_BIT(ADCx->IER, LL_ADC_FLAG_CCRDY) == (LL_ADC_FLAG_CCRDY)) ?
			1UL : 0UL);
}
