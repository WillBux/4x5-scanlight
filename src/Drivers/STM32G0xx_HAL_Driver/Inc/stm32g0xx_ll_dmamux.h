...
#define LL_DMAMUX_ReadReg(__INSTANCE__, __REG__) READ_REG(__INSTANCE__->__REG__)
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_SetRequestID(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel,
			uint32_t Request) {
		(void) (DMAMUXx);
	 ...
	 *         @arg @ref LL_DMAMUX_REQ_UCPD2_TX
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_GetRequestID(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_SetSyncRequestNb(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel,
			uint32_t RequestNb) {
		(void) (DMAMUXx);
	 ...
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_GetSyncRequestNb(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
		return (uint32_t) (((READ_BIT((DMAMUX1_Channel0 + Channel)->CCR,
				DMAMUX_CxCR_NBREQ)) >> DMAMUX_CxCR_NBREQ_Pos) + 1U);
	}
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_SetSyncPolarity(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel,
			uint32_t Polarity) {
		(void) (DMAMUXx);
	 ...
	 *         @arg @ref LL_DMAMUX_SYNC_POL_RISING_FALLING
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_GetSyncPolarity(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
		return (uint32_t) (READ_BIT((DMAMUX1_Channel0 + Channel)->CCR,
				DMAMUX_CxCR_SPOL));
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_EnableSync(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_DisableSync(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledSync(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_SetSyncID(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel,
			uint32_t SyncID) {
		(void) (DMAMUXx);
	 ...
	 *         @arg @ref LL_DMAMUX_SYNC_TIM14_OC
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_GetSyncID(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
		return (uint32_t) (READ_BIT((DMAMUX1_Channel0 + Channel)->CCR,
				DMAMUX_CxCR_SYNC_ID));
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_EnableRequestGen(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel) {
		(void) (DMAMUXx);
		SET_BIT(
				((DMAMUX_RequestGen_TypeDef *)((uint32_t)((uint32_t)DMAMUX1_RequestGenerator0 + (DMAMUX_RGCR_SIZE * (RequestGenChannel)))))->RGCR,
				DMAMUX_RGxCR_GE);
	}
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_SetGenRequestNb(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel,
			uint32_t RequestNb) {
		(void) (DMAMUXx);
		MODIFY_REG(
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO0(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO2(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO3(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO4(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO5(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO6(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO7(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO8(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO9(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO10(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_SO11(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO0(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO1(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO2(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsActiveFlag_RGO3(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO0(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO2(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO3(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO4(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO5(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO6(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO7(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO8(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO9(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO10(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_SO11(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO0(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO1(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO2(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_ClearFlag_RGO3(
			const DMAMUX_Channel_TypeDef *DMAMUXx) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_EnableIT_SO(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_DisableIT_SO(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval State of bit (1 or 0).
	 */
	__STATIC_INLINE uint32_t LL_DMAMUX_IsEnabledIT_SO(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t Channel) {
		(void) (DMAMUXx);
	 ...
	 * @retval None
	 */
	__STATIC_INLINE void LL_DMAMUX_DisableIT_RGO(
			const DMAMUX_Channel_TypeDef *DMAMUXx, uint32_t RequestGenChannel) {
		(void) (DMAMUXx);
