 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_ConfigMCO2(uint32_t MCOxSource,
		uint32_t MCOxPrescaler) {
	MODIFY_REG(RCC->CFGR, RCC_CFGR_MCO2SEL | RCC_CFGR_MCO2PRE,
			MCOxSource | MCOxPrescaler);
}
...
__STATIC_INLINE void LL_RCC_SetLPUARTClockSource(uint32_t LPUARTxSource) {
	MODIFY_REG(RCC->CCIPR, (LPUARTxSource >> 16U),
			(LPUARTxSource & 0x0000FFFFU));
}
#endif /* LPUART1 */
...
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_ADC(uint32_t Source, uint32_t PLLM,
	...
	MODIFY_REG(RCC->PLLCFGR,
			RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLP,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_I2S1(uint32_t Source,
		uint32_t PLLM, uint32_t PLLN, uint32_t PLLP) {
	MODIFY_REG(RCC->PLLCFGR,
			RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLP,
			Source | PLLM | (PLLN << RCC_PLLCFGR_PLLN_Pos) | PLLP);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_I2S2(uint32_t Source,
		uint32_t PLLM, uint32_t PLLN, uint32_t PLLP) {
	MODIFY_REG(RCC->PLLCFGR,
			RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLP,
			Source | PLLM | (PLLN << RCC_PLLCFGR_PLLN_Pos) | PLLP);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_FDCAN(uint32_t Source,
		uint32_t PLLM, uint32_t PLLN, uint32_t PLLQ) {
	MODIFY_REG(RCC->PLLCFGR,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_USB(uint32_t Source, uint32_t PLLM,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_TIM1(uint32_t Source,
		uint32_t PLLM, uint32_t PLLN, uint32_t PLLQ) {
	MODIFY_REG(RCC->PLLCFGR,
			RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLQ,
			Source | PLLM | (PLLN << RCC_PLLCFGR_PLLN_Pos) | PLLQ);
 ...
 * @retval None
 */
__STATIC_INLINE void LL_RCC_PLL_ConfigDomain_TIM15(uint32_t Source,
		uint32_t PLLM, uint32_t PLLN, uint32_t PLLQ) {
	MODIFY_REG(RCC->PLLCFGR,
			RCC_PLLCFGR_PLLSRC | RCC_PLLCFGR_PLLM | RCC_PLLCFGR_PLLN | RCC_PLLCFGR_PLLQ,
			Source | PLLM | (PLLN << RCC_PLLCFGR_PLLN_Pos) | PLLQ);
...
__STATIC_INLINE uint32_t LL_RCC_IsActiveFlag_PWRRST(void) {
	return ((READ_BIT(RCC->CSR, RCC_CSR_PWRRSTF) == (RCC_CSR_PWRRSTF)) ?
			1UL : 0UL);
}
