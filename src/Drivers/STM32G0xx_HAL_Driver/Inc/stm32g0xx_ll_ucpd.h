 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TypeCEventCC2(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_TYPECEVT2IE) == UCPD_IMR_TYPECEVT2IE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TypeCEventCC1(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_TYPECEVT1IE) == UCPD_IMR_TYPECEVT1IE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_RxMsgEnd(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_RXMSGENDIE) == UCPD_IMR_RXMSGENDIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_RxOvr(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_RxHRST(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_RXHRSTDETIE) == UCPD_IMR_RXHRSTDETIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_RxOrderSet(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_RXORDDETIE) == UCPD_IMR_RXORDDETIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_RxNE(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxUND(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxHRSTSENT(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_HRSTSENTIE) == UCPD_IMR_HRSTSENTIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxHRSTDISC(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_HRSTDISCIE) == UCPD_IMR_HRSTDISCIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxMSGABT(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_TXMSGABTIE) == UCPD_IMR_TXMSGABTIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxMSGSENT(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_TXMSGSENTIE) == UCPD_IMR_TXMSGSENTIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxMSGDISC(
		UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->IMR, UCPD_IMR_TXMSGDISCIE) == UCPD_IMR_TXMSGDISCIE) ?
			1UL : 0UL);
}
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsEnableIT_TxIS(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_FRS(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TypeCEventCC2(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TypeCEventCC1(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_RxMsgEnd(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_RxOvr(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval None
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_RxHRST(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_RxOrderSet(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_RxNE(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxUND(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxHRSTSENT(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxHRSTDISC(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxMSGABT(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxMSGSENT(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxMSGDISC(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_UCPD_IsActiveFlag_TxIS(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval val
 */
__STATIC_INLINE uint32_t LL_UCPD_GetTypeCVstateCC2(
		UCPD_TypeDef const *const UCPDx) {
 ...
 * @retval val
 */
__STATIC_INLINE uint32_t LL_UCPD_GetTypeCVstateCC1(
		UCPD_TypeDef const *const UCPDx) {
...
__STATIC_INLINE uint32_t LL_UCPD_IsEnabledTxDMA(UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->CFG1, UCPD_CFG1_TXDMAEN) == (UCPD_CFG1_TXDMAEN)) ?
			1UL : 0UL);
}
...
__STATIC_INLINE uint32_t LL_UCPD_IsEnabledRxDMA(UCPD_TypeDef const *const UCPDx) {
	return ((READ_BIT(UCPDx->CFG1, UCPD_CFG1_RXDMAEN) == (UCPD_CFG1_RXDMAEN)) ?
			1UL : 0UL);
}
