 ...
 */
typedef enum {
	USBPD_DISABLE = 0U, USBPD_ENABLE = !USBPD_DISABLE
 ...
 */
typedef struct {
	uint32_t MaxAllowablePowerIn250mWunits :10u;
	uint32_t MinVoltageIn50mVunits :10u;
	uint32_t MaxVoltageIn50mVunits :10u;
	uint32_t Battery :2u;
...
typedef union {
	uint32_t d32;
	struct {
		uint32_t BistErrorCounter :16u;
		uint32_t Reserved16_27 :12u;
		uint32_t BistMode :4u;
	} b;
