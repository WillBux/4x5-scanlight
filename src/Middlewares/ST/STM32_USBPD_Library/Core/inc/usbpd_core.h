...
typedef struct {
	 ...
	 * @retval None
	 */
	void (*USBPD_CAD_CallbackEvent)(uint8_t PortNum, USBPD_CAD_EVENT State,
			CCxPin_TypeDef Cc);
	/**
 ...
 */
USBPD_CAD_StatusTypeDef USBPD_CAD_Init(uint8_t PortNum,
		const USBPD_CAD_Callbacks *CallbackFunctions,
 ...
 */
USBPD_CAD_StatusTypeDef USBPD_CAD_SRC_SetRpResistor(uint8_t PortNum,
		CAD_RP_Source_Current_Adv_Typedef RdValue);

/** @defgroup USBPD_CORE_CAD_Exported_Functions_Legacy USBPD CORE CAD Legacy Function
 * @{
 */
/* Keep for legacy reason */
USBPD_CAD_StatusTypeDef USBPD_CAD_SetRpResistor(uint8_t PortNum,
		CAD_RP_Source_Current_Adv_Typedef RdValue);
/**
 * @}
 */
...
typedef void (*TRACE_ENTRY_POINT)(TRACE_EVENT type, uint8_t port, uint8_t sop,
...
typedef struct {
	 ...
	 */
	USBPD_StatusTypeDef (*USBPD_VDM_DiscoverIdentity)(uint8_t PortNum,
	 ...
	 */
	USBPD_StatusTypeDef (*USBPD_VDM_DiscoverSVIDs)(uint8_t PortNum,
			uint16_t **p_SVID_Info, uint8_t *pNbSVID);
	 ...
	 */
	USBPD_StatusTypeDef (*USBPD_VDM_ModeEnter)(uint8_t PortNum, uint16_t SVID,
			uint32_t ModeIndex);
	 ...
	 * @retval USBPD status @ref USBPD_ACK/@ref USBPD_NAK
	 */
	USBPD_StatusTypeDef (*USBPD_VDM_ModeExit)(uint8_t PortNum, uint16_t SVID,
			uint32_t ModeIndex);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_InformIdentity)(uint8_t PortNum,
	...
	void (*USBPD_VDM_InformSVID)(uint8_t PortNum, USBPD_SOPType_TypeDef SOPType,
			USBPD_VDM_CommandType_Typedef CommandStatus,
			USBPD_SVIDInfo_TypeDef *pListSVID);
	...
	void (*USBPD_VDM_InformMode)(uint8_t PortNum, USBPD_SOPType_TypeDef SOPType,
			USBPD_VDM_CommandType_Typedef CommandStatus,
			USBPD_ModeInfo_TypeDef *pModesInfo);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_InformModeEnter)(uint8_t PortNum,
			USBPD_SOPType_TypeDef SOPType,
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_InformModeExit)(uint8_t PortNum,
			USBPD_SOPType_TypeDef SOPType,
			USBPD_VDM_CommandType_Typedef CommandStatus, uint16_t SVID,
			uint32_t ModeIndex);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_SendAttention)(uint8_t PortNum, uint8_t *pNbData,
			uint32_t *pVDO);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_ReceiveAttention)(uint8_t PortNum, uint8_t NbData,
			uint32_t VDO);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_SendSpecific)(uint8_t PortNum,
			USBPD_SOPType_TypeDef SOPType, USBPD_VDM_Command_Typedef VDMCommand,
	...
	USBPD_StatusTypeDef (*USBPD_VDM_ReceiveSpecific)(uint8_t PortNum,
			USBPD_VDM_Command_Typedef VDMCommand, uint8_t *pNbData,
			uint32_t *pVDO);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_InformSpecific)(uint8_t PortNum,
			USBPD_SOPType_TypeDef SOPType, USBPD_VDM_Command_Typedef VDMCommand,
			uint8_t *pNbData, uint32_t *pVDO);
	 ...
	 * @retval None
	 */
	void (*USBPD_VDM_SendUVDM)(uint8_t PortNum,
			USBPD_UVDMHeader_TypeDef *pUVDM_Header, uint8_t *pNbData,
			uint32_t *pVDO);
	...
	USBPD_StatusTypeDef (*USBPD_VDM_ReceiveUVDM)(uint8_t PortNum,
			USBPD_UVDMHeader_TypeDef UVDM_Header, uint8_t *pNbData,
			uint32_t *pVDO);
...
typedef struct {
	 ...
	 * @retval None
	 */
	void (*USBPD_PE_HardReset)(uint8_t PortNum,
	 ...
	 * @retval none
	 */
	void (*USBPD_PE_Notify)(uint8_t PortNum,
	...
	void (*USBPD_PE_ExtendedMessage)(uint8_t PortNum,
			USBPD_ExtendedMsg_TypeDef MsgId, uint8_t *ptrData,
			uint16_t DataSize);
	 ...
	 * @retval None
	 */
	void (*USBPD_PE_GetDataInfo)(uint8_t PortNum,
			USBPD_CORE_DataInfoType_TypeDef DataId, uint8_t *Ptr,
			uint32_t *Size);
	 ...
	 * @retval None
	 */
	void (*USBPD_PE_SetDataInfo)(uint8_t PortNum,
	 ...
	 */
	USBPD_StatusTypeDef (*USBPD_PE_SRC_EvaluateRequest)(uint8_t PortNum,
	 ...
	 * @retval None
	 */
	void (*USBPD_PE_SNK_EvaluateCapabilities)(uint8_t PortNum,
			uint32_t *RequestData, USBPD_CORE_PDO_Type_TypeDef *PtrPowerObject);
	 ...
	 * @retval None
	 */
	void (*USBPD_PE_PowerRoleSwap)(uint8_t PortNum,
			USBPD_PortPowerRole_TypeDef CurrentRole,
	 ...
	 */
	USBPD_StatusTypeDef (*USBPD_PE_VconnPwr)(uint8_t PortNum,
	 ...
	 */
	USBPD_FunctionalState (*USBPD_PE_IsPowerReady)(uint8_t PortNum,
...
USBPD_StatusTypeDef USBPD_PE_Init(uint8_t PortNum,
		USBPD_SettingsTypeDef *pSettings, USBPD_ParamsTypeDef *pParams,
 ...
 * @retval None
 */
void USBPD_PE_Notification(uint8_t PortNum,
		USBPD_NotifyEventValue_TypeDef EventVal);
 ...
 * @retval None
 */
void USBPD_PE_InitVDM_Callback(uint8_t PortNum,
 ...
 */
USBPD_StatusTypeDef USBPD_PE_Request_CtrlMessage(uint8_t PortNum,
		USBPD_ControlMsg_TypeDef CtrlMsg,
		USBPD_SOPType_TypeDef SOPType);
 ...
 * @retval status    @ref USBPD_OK, @ref USBPD_BUSY, @ref USBPD_ERROR or @ref USBPD_FAIL
 */
USBPD_StatusTypeDef USBPD_PE_Request_DataMessage(uint8_t PortNum,
		USBPD_DataMsg_TypeDef DataMsg, uint32_t *pData);
 ...
 * @retval status    @ref USBPD_OK, @ref USBPD_BUSY, @ref USBPD_ERROR or @ref USBPD_FAIL
 */
USBPD_StatusTypeDef USBPD_PE_Send_Request(uint8_t PortNum, uint32_t Rdo,
		USBPD_CORE_PDO_Type_TypeDef PWobject);
#endif /* USBPDCORE_SNK || USBPDCORE_DRP */
 ...
 * @retval status       @ref USBPD_OK, @ref USBPD_BUSY, @ref USBPD_ERROR or @ref USBPD_FAIL
 */
USBPD_StatusTypeDef USBPD_PE_SendExtendedMessage(uint8_t PortNum,
		USBPD_SOPType_TypeDef SOPType, USBPD_ExtendedMsg_TypeDef MessageType,
 ...
 * @retval USBPD status: @ref USBPD_BUSY, @ref USBPD_OK, @ref USBPD_FAIL
 */
USBPD_StatusTypeDef USBPD_PE_SVDM_RequestSpecific(uint8_t PortNum,
		USBPD_SOPType_TypeDef SOPType, USBPD_VDM_Command_Typedef Command,
		uint16_t SVID);
#endif /* USBPDCORE_SVDM || USBPDCORE_VCONN_SUPPORT */
 ...
 * @retval USBPD status: @ref USBPD_BUSY, @ref USBPD_OK, @ref USBPD_FAIL
 */
USBPD_StatusTypeDef USBPD_PE_UVDM_RequestMessage(uint8_t PortNum,
		USBPD_SOPType_TypeDef SOPType);
#endif /* USBPDCORE_UVDM */
