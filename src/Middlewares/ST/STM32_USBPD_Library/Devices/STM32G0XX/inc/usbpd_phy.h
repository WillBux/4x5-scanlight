...
typedef struct {
	 ...
	 * @retval None
	 */
	void (*USBPD_PHY_ResetIndication)(uint8_t PortNum,
			USBPD_SOPType_TypeDef Type);
	 ...
	 * @retval None
	 */
	void (*USBPD_PHY_ResetCompleted)(uint8_t PortNum,
			USBPD_SOPType_TypeDef Type);
	 ...
	 * @retval None
	 */
	void (*USBPD_PHY_BistCompleted)(uint8_t PortNum,
			USBPD_BISTMsg_TypeDef bistmode);
...
USBPD_StatusTypeDef USBPD_PHY_ExitTransmit(uint8_t PortNum,
		USBPD_SOPType_TypeDef BistType);
